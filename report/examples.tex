...
result, which is then automatically inserted in the program. The number of the results returned by \ourTool can be easily adjusted; it is one of the parameters of our tool. In 
Section~\ref{sec:algorithm} we explain how to generate results which are most likely to be useful to the program at the point when 
